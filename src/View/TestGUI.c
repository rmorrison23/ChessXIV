...
int main(void){
	...
	ChessCoordinateList_AppendCoord(MainChessBoard->Board[0][0]);
	ChessCoordinateList_AppendCoord(MainChessBoard->Board[1][0]);
	ChessCoordinateList_AppendCoord(MainChessBoard->Board[2][0]);
