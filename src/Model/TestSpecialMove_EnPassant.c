...
int main(void){
	...
	WPawn[0]->Coordinate = MainChessBoard->Board[3][0];
	MainChessBoard->Board[3][0]->Piece = WPawn[0];	
	WPawn[1] = ChessPlayer_GetChessPiece(MainChessBoard->WhitePlayer, Pawn, 2);
	WPawn[1]->AliveFlag = True;
	WPawn[1]->PawnMoveFirstFlag = False;
	WPawn[1]->Coordinate = MainChessBoard->Board[3][2];
	MainChessBoard->Board[3][2]->Piece = WPawn[1];	
	...
	BPawn[0]->Coordinate = MainChessBoard->Board[5][1];
	MainChessBoard->Board[5][1]->Piece = BPawn[0];	
	BPawn[1] = ChessPlayer_GetChessPiece(MainChessBoard->BlackPlayer, Pawn, 2);
	BPawn[1]->AliveFlag = True;
	BPawn[1]->PawnMoveFirstFlag = False;
	BPawn[1]->Coordinate = MainChessBoard->Board[5][3];
	MainChessBoard->Board[5][3]->Piece = BPawn[1];	
